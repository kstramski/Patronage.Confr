...
using Confr.Application.Infrastructure;
...
using Confr.Common;
using Confr.Infrastructure;
using Confr.Persistence;
using Confr.WebUI.Filters;
...
namespace Confr.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(typeof(GetRoomsListQueryHandler).GetTypeInfo().Assembly);            

            // Add DbContext using SQL Server Provider
            services.AddDbContext<ConfrDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("ConfrDatabase")));
